...
void ClientMap::updateDrawList()
{
	...
	if (m_control.allow_noclip || (g_settings->getBool("freecam") && g_settings->getBool("cheats"))) {
...
void ClientMap::renderPostFx(CameraMode cam_mode)
{
	...
	if (features.solidness == 2 && cam_mode == CAMERA_MODE_FIRST &&
		!(m_control.allow_noclip || (g_settings->getBool("freecam") && g_settings->getBool("cheats")))) {
